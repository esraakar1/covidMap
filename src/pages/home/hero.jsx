    ...
    <div className='bg-blue-900 text-white'>
        <div className='container py-10 pb-16 md:pt-[100px] md:pb-[120px] grid md:grid-cols-2 gap-5'>
            <div className='gap-5 md:gap-10 flex flex-col'>
                ...
                <p className='text-gray-300'>   Koronavirüs hastalığı 2019 şiddetli akut solunum sendromu koronavirüsü 2'nin neden olduğu bulaşıcı bir hastalıktır. İlk vaka ile
            Çin'in Hubei eyaletinin Wuhan şehrinde Kasım 2019 tarihinde karşılaşılmıştır.</p>
